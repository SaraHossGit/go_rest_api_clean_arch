...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions errorHandler) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(NetworkExceptions errorHandler)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NetworkExceptions errorHandler});

  $NetworkExceptionsCopyWith<$Res> get errorHandler;
}
...
class __$$FailureImplCopyWithImpl<T, $Res>
  ...
  @pragma('vm:prefer-inline')
  $NetworkExceptionsCopyWith<$Res> get errorHandler {
    return $NetworkExceptionsCopyWith<$Res>(_value.errorHandler, (value) {
      return _then(_value.copyWith(errorHandler: value));
    });
  }
}
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  final NetworkExceptions errorHandler;
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final NetworkExceptions errorHandler) =
      _$FailureImpl<T>;

  NetworkExceptions get errorHandler;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
